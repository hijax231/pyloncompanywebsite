...
<div class="col-12 bg-primary mt-5 pt-5">
...
<div class="bgimg-1">
  ...
  <div  id="carousel-example-1z" class="p-0 carousel slide carousel-fade" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				...
				<!--Third slide-->
				<div class="carousel-item">
					<img class="d-block w-100" src="<?php echo base_url().'/assets/img/caru/ebpls.png' ?>" alt="Third slide">
				</div>
				...
				<div class="carousel-item">
					<img class="d-block w-100  h-50" src="<?php echo base_url().'/assets/img/caru/hr.png' ?>" alt="Third slide">
				</div>
...
<div class="col-12 text-center">
					<button data-toggle="modal" data-target="#list" class="btn btn-lg btn-info m-3"><i class="fas fa-project-diagram text-white fa-2x"></i><br><h3 class="text-white">List of Projects</h3> </button>
          </div>
          <div class="col-12 text-center">
					<button data-toggle="modal" data-target="#10yrs"class="btn btn-lg btn-primary m-3"><i class="fas fa-glass-cheers text-white fa-2x"></i><br><h3 class="text-white">Projects Last Ten Years</h3> </button>
          </div>
...
<!-- Modal -->
<div class="modal fade" id="10yrs" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      <div class="modal-header">

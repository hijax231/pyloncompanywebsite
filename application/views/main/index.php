...
<div id="home" class="col-lg-12 col-sm-12 marginmobile mt-3  "></div>
<div class="bgimg-1">
	<div class="row pt-5">
				...
				<div class="card round text-left">
					...
					<div class="card-body ">
						...
						<div class="col-lg-12 col-sm-12 text-center p-0 pt-5 pb-3">
							...
							<video id="videoquarantine" width="100%" controls>
								<source src="<?php echo base_url().'/assets/img/video/taytay_qp.mp4' ?>"
									type="video/mp4" />
	...
	<div class="container">
		<div class="row">
				...
				<div class="card">
					<div class="card-body" style="color:black;background-color: white;">
						...
						<ul class="list-group pl-3">
							...
							<li class="">Tricycle Franchising System</li>
							<li class="">Treasury Collection System</li>
			...
			<div class="col-lg-4 col-sm-12 mt-3 mb-5" align="center">
				<img height="440px" class="responsive pt-5 mt-5" src="<?php echo base_url().'/assets/img/pylon2.png' ?>"
					alt="">
			</div>
					...
					<div class="col-lg-12 pt-3">
						<div class="card">
							<div class="card-body l1" id="" style="color:black;background-color:white;">
								...
								<div class="col-lg-12 text-center">
									<button data-toggle="modal" data-target="#10yrs"
										class="btnres btn-primary btn btn-md"><i
...
<div id="projectslist" class="bgimg-2">
	<div class="caption">
		<span class="border" style="background-color: #0f0f0f;font-size:25px;color: #dfe0d4;border-radius: 12px;"><b
				class="list_projects">LIST OF PROJECTS</b> </span>
	</div>
</div>
	...
	<div id="" class="pm" style="color: #777;background-color:#F1F1F1;text-align:center;text-align: justify;">
		...
		<div class="carsel m-auto p-3" style="color:black;background-color:white;">
			<div class="carsel-inner ">
				<input class="carsel-open" type="radio" id="carsel-1" name="carsel" aria-hidden="true" hidden=""
					checked="checked">
				<div class="carsel-item">
					<img class="m-auto" src="<?php echo base_url().'/assets/img/proj_list/1.png' ?>" alt="First slide">
				</div>
				<input class="carsel-open" type="radio" id="carsel-2" name="carsel" aria-hidden="false" hidden=""
					checked="checked">
				<div class="carsel-item">
				...
				<input class="carsel-open" type="radio" id="carsel-4" name="carsel" aria-hidden="true" hidden=""
					checked="checked">
				<div class="carsel-item">
					<img class="m-auto" src="<?php echo base_url().'/assets/img/proj_list/3_page2.png' ?>"
						alt="First slide">
				</div>
...
<div id="about" class="bgimg-2">
	<div class="caption">
		<span class="border"
			style="background-color: #0f0f0f;font-size:25px;color: #dfe0d4;border-radius: 12px;"><b>ABOUT US</b> </span>
	</div>
</div>

<!-- <div style="position:relative;">
		<div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
			<h2 class="text-center text-white">ABOUT US</h2>		</div>
	</div> -->
...
<div class="pm1" style="color:black;background-color:#F1F1F1;text-align:center;text-align: justify;">
	...
	<p><b>PYLON INTERNATIONAL TRADING</b> was founded in the late 80's and represented as a single proprietor company
		...
		finding pastes) office equipment and supplies including novelty items and corporate give-away.</p>
	...
	<p>On March 2000, PITC ventured into Information Technology with the purpose of providing local
		government units (LGU’s) of integrated IT-based solutions. For this, we partnered with a leading IT
		development company, for the purpose of implementing our vision
	</p>

	<p>In late 2003, PITC decided to venture on its own IT solution and invested to develop an eLearning
		solution for Grade School and High School level at the same time a One-Stop solution to be used by
		Local Government units to handle Revenue Tax Collections. In the middle of 2006, PITC was able to
		sign two (2) contracts, one for the eLearning solution and the other one for LGU Tax Collection solution.
		Both projects are now being used.
	</p>
	...
	<p>PITC has a team of highly qualified IT software designers and consultants to support the installation of
		hardware and software for the Local Government Unit’s (LGU’s) and private organizations. Among the
		services offered are as follows: Software Development, System Analysis, Database Build up, 3D Designs,
...
<div id="contact" class="bgimg-3">
	<div class="caption">
		<span class="border"
			style="background-color: #0f0f0f;font-size:25px;color: #dfe0d4;border-radius: 12px;"><b>CONTACT US</b>
		</span>
	</div>
</div>

<div style="position:relative;">
	<div class="pm1" style="color:#ddd;background-color: #2e2e32;text-align:center;text-align: center;"
		class="text-white">
		<div class="row">
			<div class="col-lg-6 col-sm-12">

				<img height="175px" class="responsive pconta" src="<?php echo base_url().'/assets/img/mail.png'?>"
					alt="">
			</div>
	...
	<div class="row">
		<div class="col-lg-4 col-sm-12">
			<img src="<?php echo base_url() .'/assets/img/logo.png'?>" height="40px" alt="" srcset=""><br><b>
				301-P Cityland 10,Tower II,<br> 6817 H.V. Dela Costa, Ayala Avenue North,<br> Makati City, Metro Manila
...
<div style="position:relative;">
	<div class="text-white"
		style="color:#ddd;background-color:#232323;text-align:center;padding:15px 80px;text-align: center;">
	...
	<div class="modal-dialog " role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">List of Projects</h5>
...
<!-- Modal -->
<div class="modal fade" id="10yrs" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog " role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">List of Projects</h5>
